...
local samples = 4096 -- Increasing this value makes statistics less prone to sudden spikes but also less flexible
...
while true do -- Start a loop while the bot should be running.
	...
	if err then 
		print(err)
		pcall(api.sendLog(err)) -- Even this may arise errors!
